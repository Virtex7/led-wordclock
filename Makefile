...
#DEBUG = stabs
# DEBUG = dwarf-2
# DEBUG UNTEN BEI CFLAGS AUSKOMMENTIERT!!!
...
ASFLAGS += -DF_OSC=$(F_OSC) -DF_CPU=$(F_CPU)
...
ramusage: $(TARGET).o
	{ echo -e "(all values decimal)\naddr     usage    what          where"; $(NM) -t d -lS --size-sort $(TARGET).o -n; } | less
